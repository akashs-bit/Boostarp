...
<nav class="navbar navbar-inverse">
	<div class="container-fluid bg-success">
       <ul class="nav nav-tabs bg-danger"> 
        <img src="header.jpg" height="203px" width="1750px">
...
<style>
	#hd{border-radius: 10px; background-color: white;}
    #hd1{border-radius: 10px; color: white;}
#tx{border-radius: 10px; background-color:white; color:black; font-size: 14pt;}
#bt{border-radius: 10px;background-color: green;color: white; font-size:14pt;}
#tab1{border-radius: 10px; background-color:slateblue; color: white; font-size: 14pt;}
#tab2{border-radius: 10px; background-color:white; color: black; font-size: 14pt;}

body{border-radius: 10px; background-color:gray;}
</style></head></html>
<center>
<h1 style="color:black;"> Search Records</h1>
<br>
<br>
<table id="tab1">
...
<td><input type="submit" name="s1" value="search" id="bt"></td>
</tr></form></table>
<br><br>
<?php
if(isset ($_POST['s1']))
...
$result = mysqli_query($con,"SELECT * FROM `std_info` WHERE sname LIKE '$sn%'");


echo"<center>";
echo"<h2></h2><br>";
echo"<table border=1 id='tab2'>";
...
<br><br>
<tr><td><a href="http://localhost/InsertDatabase/Welcome.php"><font size="5"><b> Go to home page</a></td></tr>
	<br><br>
