...
<style>
	#tab1{border-radius: ; background-color:lightgray; font-family: tahoma; color: black; font-size: 19.5pt; border-color: white;}
    #tab2{border-radius: ; background-color:lightgray; font-family: tahoma; color: black; font-size: 20.5pt; border-color: white;}
        #tab3{border-radius: ; background-color:lightgray; font-family: tahoma; color: black; font-size: 16.7pt; border-color: white;}
</style>
<body>
<center>
...
<table border="0" cellpadding="3" cellspacing="3" id="tab1">
<tr>
<td>User Name:</td>
<td><input type="text" id="username" name="username" placeholder="Username" required/> </td></tr></table>
<br>

<tr>
<table id="tab2" border="0" cellpadding="3" cellspacing="3">
<td>Password:</td>
<td><input id="password" name="password" type="password" required/> </td></tr></table>
<br>

<tr>
<table id="tab3" border="0" cellpadding="3" cellspacing="3">
<td>Confirm Password:</td>
<td><input id="confirmpassword" name="confirmpassword" type="password" required/></td></tr>
</table>
<center>
	<br>
 <input type="submit" name="submit" value="Register" style="border-radius:10px; background:lightcoral; color:black; border-color:green;"> <font color="white">Already have an user account? </font>
	<br>
	<center>
	<a href="http://localhost/InsertDatabase/Login2.php"><font color="black"><font color="white">Click here</font></a></td></tr>
