...
#bt1{border-radius: 10px;background-color:green;color:white; font-size:14px;}
#bt2{border-radius: 10px;background-color: red;color: white; font-size: 14px}
#tab1{border-radius: 10px; background-color:lightblue; color: black; font-size: 16pt; border-color: white;}
#tab2{border-radius: 10px; background-color:lightblue; color: black; font-size: 15pt; border-color: white;}
#tab3{border-radius: 10px; background-color:lightblue; color: black; font-size: 17pt; border-color: white;}
body{border-radius: 10px; background-color: gray;}
</style>
<center>
<table id="tab1" border="0" cellpadding="15" cellspacing="15">
	<h1 style="color:black;"> Insert Student Records</h1>
	<br>
	<form name="f1" action="insert.php" method="POST">
		<tr>
		<td>Rool Number : </td><td><input type="text" name="t1" id="tx"><br></td></tr>
	</table>
	<br>
	<tr>
	<table border="0" cellpadding="15" cellspacing="15" id="tab2">
		<td>Student Name :</td><td><input type="text" name="t2" id="tx"><br></td></tr>
	</table>
	<br>
	<tr>
	<table border="0" cellpadding="15" cellspacing="15" id="tab3">
		<td>Class Name :</td><td><input type="text" name="t3" id="tx"><br></td></tr>
	</table>
	<br>
		<tr>
		<td><input type="submit" name="b1" value="insert" id="bt1"></td>
		<td><input type="Reset" name="r1" value="Reset" id="bt2"></td></tr>
		</form></table>
...

{
	...
	$con=mysqli_connect("$host","$username","$possword","$dbname");

 
    mysqli_query($con,"INSERT INTO std_info (rollno,sname,class) values ('$rl','$sn','$cl')");

    echo "<h1 style='color:black'> One Record Added! Thank you</h1>";
    mysqli_close($con);	
...
<br><br><br>
<tr><td><a href="http://localhost/insertDatabase/Welcome.php"><font size="5"> <b>Go to home page
</b></a></td></tr></center>
<br><br>
